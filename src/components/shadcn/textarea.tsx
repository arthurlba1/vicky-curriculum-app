...
function TextareaForm({ name, variant = "default", ...props }: TextareaFormProps) {
          ...
          <FormItem>
            <FormControl>
              <Textarea
                ...
                className={cn(props.className, "resize-none overflow-hidden min-h-[2rem] transition-[height] duration-200 ease-in-out")}
              />
            </FormControl>
            <FormMessage />
          </FormItem>
